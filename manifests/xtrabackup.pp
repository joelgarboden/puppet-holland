...
#
# @param ensure
#   Should the xtrabackup provider be installed or not.
#
# @param additional_options
#   Specify additional options directly to the `xtrabackup` command if there is
...
#   Whether or not to pipe the output of `xtrabackup` into the compression
